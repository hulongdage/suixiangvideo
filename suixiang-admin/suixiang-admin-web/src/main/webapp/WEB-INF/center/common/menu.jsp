        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="false" data-slide-speed="200" style="padding-top: 20px">
				...
				<li class="nav-item ">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item ">
                            <a href="<%=request.getContextPath() %>/user/showUserList.action" class="ajaxify nav-link ">
				...
				<li class="nav-item ">
                    ...
                    <ul class="sub-menu">
						<li class="nav-item ">
                            <a id="bgmListMenu" href="<%=request.getContextPath() %>/bgm/toBgmListPage.action" class="ajaxify nav-link " id="bgmListMenu">
                                <span class="title">bgm列表</span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a id="addBgmPage" href="<%=request.getContextPath() %>/bgm/toAddBgmPage.action" class="ajaxify nav-link ">
