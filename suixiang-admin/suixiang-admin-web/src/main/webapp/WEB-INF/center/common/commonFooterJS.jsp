...
<input type="hidden" id="apiServer" name="apiServer" value="http://39.107.120.122:81"/> 
<input type="hidden" id="bgmServer" name="bgmServer" value="http://39.107.120.122:81/mvc"/>
<!-- <input type="hidden" id="apiServer" name="apiServer" value="http://192.168.25.1:8080"/> 
