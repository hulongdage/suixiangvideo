...
<body class="login" style="background-image: url('<%=request.getContextPath()%>/static/pages/img/center/loginbg.jpg');">
        <!-- BEGIN LOGO -->
        <div class="logo">
        ...
        <input type="hidden" id="loginContextPath" name="loginContextPath" value="<%=request.getContextPath() %>"/>
